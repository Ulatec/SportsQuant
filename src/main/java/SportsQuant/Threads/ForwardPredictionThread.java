...
public class ForwardPredictionThread extends Thread {
    private ForwardPredictionThreadMonitor threadMonitor;
...
//PlayerStatFilter playerStatFilter;
    ...
    public ForwardPredictionThread(HashMap<Integer, GameOdds> gameOddsHashMap, List<Game> gameList, int threadNum) {
    ...
    public synchronized void setThreadMonitor(ForwardPredictionThreadMonitor threadMonitor) {
...
//                            float AwayPredictedPoints = (float) scoreModel.getAwayPointsPerGame();
    ...
    public static void mergeScores(SportsQuant.Model.ScoreModel scoreModel) {
